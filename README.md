...
Additional validation is carried out for emails, phone numbers etc, and if a URL is entered but has no prefix then https:// is added automatically.

Form data is persisted to local storage to help with little edits.
